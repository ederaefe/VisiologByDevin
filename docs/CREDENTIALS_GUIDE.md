...
1. **Navigate to AI Studio**: Go to [https://aistudio.google.com/](https://aistudio.google.com/)
...
7. **Store it**: This value goes into your `.env` file as `VITE_GEMINI_API_KEY`.
...
### Step-by-Step Directions:
1. **Navigate to Supabase**: Go to [https://supabase.com/](https://supabase.com/) and click **"Start your project"** (or Sign In).
2. **Create a Project**:
...
### Step-by-Step Directions:
1. **Navigate to Cloudinary**: Go to [https://cloudinary.com/](https://cloudinary.com/) and Sign Up / Log In.
...
4. **Copy the Credentials**:
   You need three specific values from this card:
