  ...
  return (
    <div className="upload-gate">
      <div className="upload-gate-card">
        ...
        <p>Securely send images or structured files into your VISIOLOG workspace.</p>
        <form onSubmit={submit}>
          <label htmlFor="upload-passcode">Passcode</label>
          <input
            id="upload-passcode"
            type="password"
            autoFocus
          ...
          <button className="btn btn-primary upload-submit" disabled={busy} type="submit">
            {busy ? 'Verifying…' : 'Continue'}
          </button>
        </form>
        <a className="upload-back-link" href="/">← Back to VISIOLOG</a>
      </div>
    </div>
  );
}
